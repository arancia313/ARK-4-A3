...
copy-bin:
	...
	$(Q)cp loader/live/user/linkless_payload/H.BIN dist/ARK_30000/H.BIN # game exploit loader
	...
	$(Q)cp loader/live/kernel/kxploit/sceUID/K.BIN dist/ARK_30000/K.BIN # Kernel exploit for PSP 6.6X and Vita 3.60+
	...
	$(Q)cp extras/modules/xmbctrl/xmbctrl.prx dist/ARK_30000/XMBCTRL.PRX # XMB Control Module
	$(Q)cp extras/modules/idsregeneration/idsregeneration.prx dist/ARK_30000/IDSREG.PRX # idsregeneration
	...
	$(Q)cp extras/modules/intraFont/intraFont.prx dist/ARK_30000/INTRAFON.PRX
	$(Q)cp extras/modules/unarchive/unarchive.prx dist/ARK_30000/UNARCH.PRX
	$(Q)cp extras/menus/recovery/ark_recovery.prx dist/ARK_30000/RECOVERY.PRX # Default recovery menu
	$(Q)cp extras/menus/arkMenu/EBOOT.PBP dist/ARK_30000/VBOOT.PBP # Default launcher
	$(Q)cp extras/menus/arkMenu/LANG.ARK dist/ARK_30000/LANG.ARK # Translations
	$(Q)cp extras/menus/xMenu/EBOOT.PBP dist/ARK_30000/XBOOT.PBP # PS1 launcher
	...
	$(Q)cp contrib/SETTINGS.TXT dist/ARK_30000/
	$(Q)cp contrib/PSP/mediasync.prx dist/ARK_30000/MEDIASYN.PRX
	$(Q)cp contrib/PSP/popsman.prx dist/ARK_30000/POPSMAN.PRX
	$(Q)cp contrib/PSP/pops_01g.prx dist/ARK_30000/POPS.PRX
	$(Q)cp -r extras/menus/arkMenu/themes dist/
	$(Q)rm -rf dist/themes/translations
	$(Q)cp contrib/README.TXT dist/
	$(Q)mv dist/FLASH0.ARK dist/ARK_30000/ # flash0 package
	$(Q)cp -r dist/ARK_30000 dist/PSP/ARK_DC/
	$(Q)cp -r dist/ARK_30000 dist/PC/MagicMemoryCreator/TM/DCARK/
	$(Q)find dist/themes/ -type d -name 'resources' -exec rm -rf {} \; 2>/dev/null || true
	$(q)mkdir -p loader/vpk/bin/save/ARK_30000
...
clean:
	...
	$(Q)rm -f extras/apps/updater/ARK_30000.PKG | true
	...
	$(Q)rm -rf loader/vpk/bin/save/ARK_30000
